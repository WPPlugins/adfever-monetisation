...
function AF_options_do_page() {
	...
	<div class="wrap">
	    ...
	    <p>
	    Le plugin AdFever vous permet d'insérer des liens sponsorisés au sein de vos articles. Vous pourrez ainsi offrir un nouveau service à vos visiteurs tout en bénéficiant de revenus additionnels. Pour activer le plugin, veuillez remplir les informations ci-dessous. Vous pourrez alors personnaliser votre plugin.<br />
	    Votre AID AdFever vous permet d'activer les liens sponsorisés.
	    </p>
	    <label for="AF_options[AF_AID]">Votre AID AdFever: <span> *</span></label>
	    ...
	    <p>Vous ne disposez pas d’AID AdFever? <a href="http://www.adfever.com/?utm_source=adminpluginWP" target="_blank">Inscrivez-vous sur AdFever.com</a>, ajoutez votre site et attendez la validation annonceur, vous recevrez un AID sur votre adresse email.</p>
